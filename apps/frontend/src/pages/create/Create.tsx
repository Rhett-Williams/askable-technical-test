...
const Create = () => {
  ...
  const validationSchema = Yup.object({
    ...
    category: Yup.string().required('Category is required').oneOf(["Sneakers", "Clothing", "Watches", "Hats"], 'Invalid category'),
    ...
    return (
      ...
      <Form>
        ...
        <div className="form-item">
          ...
          <ErrorMessage className="error-text" name="category" component="div" />
        </div>
        ...
        <button className="form-item" type="submit">{isCreateLoading ? <ColorRing
                  visible={true}
                  height="20"
                  width="20"
